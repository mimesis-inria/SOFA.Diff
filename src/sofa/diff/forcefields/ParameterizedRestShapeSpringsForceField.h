...
class ParameterizedRestShapeSpringsForceField:
    public Parameterized,
    public RestShapeSpringsForceField<Vec3Types>
{
public:
    SOFA_CLASS(ParameterizedRestShapeSpringsForceField, RestShapeSpringsForceField<Vec3Types>);
