...
class SOFA_SOFADIFF_API StoreStateVisitor: public simulation::Visitor
{
public:
    StoreStateVisitor(const ExecParams* params, const MultiVecCoordId& positionId, const MultiVecDerivId& velocityId);
